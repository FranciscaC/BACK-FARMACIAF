...
public class UserDetailServiceImplementation implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        List<SimpleGrantedAuthority> authorityList = buildAuthorityList(userEntity);
        return new User(
    ...
    private List<SimpleGrantedAuthority> buildAuthorityList(UserEntity userEntity) {
        List<SimpleGrantedAuthority> authorities = new ArrayList<>();
        userEntity.getRoles().forEach(role ->
                authorities.add(new SimpleGrantedAuthority(SecurityConstant.ROLE_PREFIX.concat(role.getRoleEnum().name()))));
