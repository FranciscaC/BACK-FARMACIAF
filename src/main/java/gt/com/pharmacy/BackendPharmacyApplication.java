package gt.com.pharmacy;

import gt.com.pharmacy.persistence.entity.PermissionEntity;
...
public class BackendPharmacyApplication {

    public static void main(String[] args) {
        SpringApplication.run(BackendPharmacyApplication.class, args);
    }
    ...
    CommandLineRunner init(IUserRepository iUserRepository) {
        return args -> {
            ...
            Optional<UserEntity> existingAdmin = iUserRepository.findUserEntityByUsername("pharmacy_admin");
            Optional<UserEntity> existingUser = iUserRepository.findUserEntityByUsername("pharmacy_user");
